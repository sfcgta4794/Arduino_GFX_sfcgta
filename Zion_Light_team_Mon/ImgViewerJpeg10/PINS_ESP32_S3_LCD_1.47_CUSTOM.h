...
#define SWITCH_INTERVAL_MS     3000 // define how many second before switching to other image
#define SLIDESHOW_MAX_IMAGES   10   // Hard limit constraint for dynamic list allocation
